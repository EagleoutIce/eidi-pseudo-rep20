...
% für die Heap und Stack Freuden
...
\renewcommand*\stackmElement[2] {\hsmElement{(0.5,#1)}{#2}{btcd@color@primary}}

%% -----------------------------------------------------------------------------
%% Theme
%% -----------------------------------------------------------------------------
\def\ThemePath{beamer-themes/colorful-dream/}
\usepackage[emblem,theorems]{\ThemePath/beamerthemecolorful-dream}
...
\lstcolorlet{literals}{btcd@color@secondary!75!btcd@color@white}
\makeatletter
...
\AtBeginDocument{%
    \tikzumlset{fill class=btcd@color@white,font=\small\ttfamily}%
