...
%% TikZ
\tikzset{
    block/.style={rectangle,draw,#1,font=\@declaredcolor{btcd@color@black},rounded corners=\z@,minimum height=\baselineskip,execute at begin node={\strut},rounded corners=\p@},
    block/.default=solidF,
    iblock/.style={block=btcd@color@primary,fill=btcd@color@primary!21!btcd@color@white},
    ball/.style={circle,draw,#1,font=\@declaredcolor{btcd@color@black}},
