...
Sonst soll (3) B durchgeführt werden.}}\quad
...
\color{black}\parbox{.29\linewidth}{\centering Textuell\par}\quad\parbox{.29\linewidth}{\centering Grafisch\par}\quad\parbox{.29\linewidth}{\centering Pseudocode\par}
\end{center}\medskip
...
\begin{frame}{Algorithmuseigenschaften}
    \begin{itemize}[<+(1)->]
        ...
        \item Ein Algorithmus besitzt einige grundlegende \imp{Eigenschaften}: \begin{description}[Ausführbarkeit]
            ...
            \item[Termination] Er kommt nach endlich vielen Schritten zum Ende.
            \item[Verarbeitung] Ein Algorithmus erhält Eingabedaten \(E\),\pause{} hält lokale Daten \(D\)\pause{} und erzeugt Ausgabedaten \(A\).
        \end{description}
    \end{itemize}
\end{frame}
