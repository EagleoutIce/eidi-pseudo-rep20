...
\begin{frame}[c,fragile]{Übungsaufgabe}
    ...
    \begin{exercise}<2->[Sichtbarkeiten \Time{6}]
        {\small Welche der Aufrufe (1 bis 6) sind gültig oder ungültig und warum? Nehmen Sie an, dass die Dateien \& Importe korrekt sind. \bjava{B extends A} heißt: \bjava{B} erbt von \bjava{A}.\smallskip\par}
\begin{uncoverenv}<4->
