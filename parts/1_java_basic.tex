...
!*\onslide<3->*!}
\end{plainjava}
    \item Die Klasse \bjava{Tiger} sei im selben, \bjava{Auto} sei in einem anderen Paket, \bjava{Felspingu} erbe von \bjava{Pinguin} und in anderem Paket. Sichtbarkeiten:\medskip\par\pause{}
    {\def\y{\faCheckSquareO}\def\n{\hspace*{-1pt}\faSquareO}\scriptsize\begin{minipage}{0.45\linewidth}
