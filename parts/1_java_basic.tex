...
\begin{frame}[c,fragile]{Übungsaufgabe}
    ...
    \begin{exercise}<2->[Sichtbarkeiten \Time{6}]
        Welche der Aufrufe (1 bis 6) sind gültig oder ungültig und warum? Nehmen Sie an, dass die Dateien und Importe korrekt sind. \bjava{B extends A} beschreibt, dass \bjava{B} von \bjava{A} erbt.\medskip\par
\begin{uncoverenv}<4->
