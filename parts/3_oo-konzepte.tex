...
\begin{frame}{Implementation in Java}
    ...
    \begin{definition}<8->[Konstruktor]
        ...
        Ein Konstruktor trägt stets den selben Namen wie die Klasse selbst und kann den Aufruf an andere Überladungen des Konstruktors mittels \bjava{this} durchreichen.
    \end{definition}
\end{frame}
...
\begin{frame}[fragile]{Der Lebenszyklus eines Objekts}
    \begin{itemize}[<+(1)->]
        ...
        \item Existiert für ein Objekt keine Referenz mhe,\pause{} gibt es (für Java) keine Möglichkeit mehr darauf zuzugreifen.
