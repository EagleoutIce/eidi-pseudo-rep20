...
\begin{equation*}
    ...
    \end{cases}
\end{equation*}
    Approximieren Sie die natürlichen Zahlen durch den Java Datentyp \bjava{long}. Sie dürfen \emph{keine} Java Funktionen zur Hilfe benutzen.
...
\emSetFieldSize{4cm}{4cm}%
\emSetTileSize{.65cm}{.65cm}%
\emSetPlayerSize{.5cm}{.5cm}%
\emSetTileOffset{.65cm}{.65cm}%
\colorlet{chessfieldblack}{black!85!white}%
\colorlet{chessblack}{btcd@color@secondary}
\colorlet{chesswhite}{btcd@color@alerted}
\emSetField{0/\em@W\em@B\em@W\em@B\em@W,0/\em@B\em@W\em@B\em@W\em@B,0/\em@W\em@B\em@W\em@B\em@W,0/\em@B\em@W\em@B\em@W\em@B,0/\em@W\em@B\em@W\em@B\em@W}%
    \begin{exercise}<2->[Das \(n\)-Türme Problem \Time{7}]%
        \smallskip\par\parbox[b]{.735\linewidth}{\onslide<3->{Ein Turm kann einen anderen auf einer vertikalen und horizontalen Linie schlagen. Im rechten \(5\times 5\) Feld, zum Beispiel der rote Turm den am roten Punkt.}\smallskip
...
\foreach \i in {16,18,19,20,7,12,22} {
    \fill[btcd@color@primary] (emline\i) circle [radius=2pt];
}
\fill[btcd@color@alerted] (emline2) circle [radius=2pt];
\emChessSetBoard{%
    {,black:rookB,,,,,,black:rookB},
    {,,,,,,black:rookB,,white:rookB},
    {},
    {}%
}%
\end{eagle-map*}}\par%
...
!*\onslide<4->*!    return check(arr, 0, 0); // Start left upper corner
!*\onslide<3->*!}
!*\onslide<3->*!
!*\onslide<5->*!boolean check(boolean[][] arr, int y, int x) {
!*\onslide<6->*!    if(y >= arr.length) return false; // done
!*\onslide<7->*!    // Next line
!*\onslide<7->*!    if(x >= arr.length) return check(arr, y + 1, 0);
!*\onslide<8->*!    if(arr[y][x] && canBeatOtherRook(arr, y, x)) return true;
!*\onslide<3->*!
!*\onslide<9->*!    return check(arr, y, x + 1);
!*\onslide<5->*!}
\end{plainjava}
    \end{solve}
\end{frame}
