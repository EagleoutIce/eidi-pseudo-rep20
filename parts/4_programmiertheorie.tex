...
\begin{tabular}{c*{8}{c}}
    \toprule
    & \onslide<9->{\cellcolor{@primary!100!@alerted!21} \(\O(1)\)} & \onslide<10->{\cellcolor{@primary!85!@alerted!21}\(\O(\log n)\)} & \onslide<11->{\cellcolor{@primary!69!@alerted!21} \(\O(n)\)} & \onslide<12->{\cellcolor{@primary!53!@alerted!21} \(\O(n\log n)\)} & \onslide<13->{\cellcolor{@primary!36!@alerted!21} \(\O(n^2)\)} & \onslide<14->{\cellcolor{@primary!19!@alerted!21} \(\O(n^3)\)} & \onslide<15->{\cellcolor{@primary!14!@alerted!21} \(\O(2^n)\)} & \onslide<16->{\cellcolor{@primary!0!@alerted!21} \(\O(n!)\)} \\[0.45ex]\midrule
