...
\begin{frame}[c]{Lösung}
    \begin{solve}<2->[Sortieralgorithmen zeichnen, II]
        ...
        \begin{enumerate}
            \widei
            \item<4-> \only<8->{\color{gray}}\begin{tikzpicture}[scale=0.6,every node/.style={transform shape},baseline=-0.6ex]
                \QsList{3, -5, -4, 2, 6}{1}
            \end{tikzpicture}\onslide<5->{\quad Tausch ans Ende:\quad\begin{tikzpicture}[scale=0.6,every node/.style={transform shape},baseline=-0.6ex]
                \QsList{6, -5, -4, 2, 3}{5}
            ...
            \end{tikzpicture}}}\medskip\par
            \only<8->{\color{black}}\onslide<7->{Tausche \(l\) und Pivot:\quad\begin{tikzpicture}[scale=0.6,every node/.style={transform shape},baseline=-0.6ex]
                \QsList{2, -5, -4, 3, 6}{4}
            \end{tikzpicture}}
            \item<9-> \only<13->{\color{gray}}Links: \begin{tikzpicture}[scale=0.6,every node/.style={transform shape},baseline=-0.6ex]
                \QsList{2, -5, -4}{1}
                \begin{scope}[xshift=3*3.5em,densely dashed,gray]
                    \QsList{3, 6}{0}
                \end{scope}
            \end{tikzpicture}\onslide<10->{\quad Tausch ans Ende:\quad\begin{tikzpicture}[scale=0.6,every node/.style={transform shape},baseline=-0.6ex]
                \QsList{-4, -5, 2}{3}
                \begin{scope}[xshift=3*3.5em,densely dashed,gray]
                    \QsList{3, 6}{0}
                \end{scope}
            \end{tikzpicture}}\medskip\par
            \onslide<11->{\begin{tikzpicture}[scale=0.6,every node/.style={transform shape},baseline=-0.6ex]
                \QsList{-4, -5, 2}{3}
                ...
                \end{scope}
            \end{tikzpicture}}\medskip\par
            \only<13->{\color{black}}\onslide<12->{Tausche \(l\) und Pivot:\quad\begin{tikzpicture}[scale=0.6,every node/.style={transform shape},baseline=-0.6ex]
                \QsList{-4, -5, 2}{3}
                \begin{scope}[xshift=3*3.5em,densely dashed,gray]
                    \QsList{3, 6}{0}
                \end{scope}
