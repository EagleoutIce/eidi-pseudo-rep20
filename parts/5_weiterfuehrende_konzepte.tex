...
\begin{frame}[c]{Übungsaufgabe}
    ...
    \begin{exercise}<2->[Sortieralgorithmen zeichnen, I \Time{5}]
        \pause{}Veranschaulichen Sie den Sortierprozess der Zahlenfolge \say{\(5,7,2,5,3,-19,6\)} unter der Verwendung von \linksort{Mergesort} grafisch. Geben Sie jeden Schritt an und sortieren Sie aufsteigend.
    \end{exercise}
\end{frame}
