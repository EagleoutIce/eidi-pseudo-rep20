...
\ifull
\begin{frame}[fragile,c]{Selectionsort implementieren}
...
\begin{frame}{Sortierverfahren: Bubblesort}\alglabel{Bubblesort}
    ...
    \begin{itemize}
        ...
        \item<6-> Verbesserung: Shaker-Sort, schiebt abwechselnd das maximale und minimale Element an die (Ziel-)Position.
    \end{itemize}
    \vfill
    \begin{center}\pause
\begin{minipage}{0.9\linewidth}
