...
\begin{frame}[c]{Übungsaufgabe}
    ...
    \begin{exercise}<2->[Sortieralgorithmen zeichnen \Time{5}]
        \pause{}Veranschaulichen Sie den Sortierprozess der Zahlenfolge \(5,7,2,5,3,-19,6\) unter der Verwendung von \emph{Mergesort} grafisch. Geben Sie jeden Schritt an.
    \end{exercise}
\end{frame}
