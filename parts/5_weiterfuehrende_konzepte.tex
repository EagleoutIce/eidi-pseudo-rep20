...
\begin{frame}[c]{Shakersort visualisieren -- Lösung}
    ...
    \begin{enumerate}[<+(1)->]
        ...
        \textit{Dieser Schritt kann theoretisch weggelassen werden, wenn man die optimierte Version von Shakersort benutzt. Diese bricht ab, sobald in einem Durchlauf nicht mehr getauscht wird.}
    \end{enumerate}
    \end{solve}
\end{frame}
\fi
