...
\end{plainjava}
        \pause{}Schreiben Sie eine Methode \bjava{appendLast(Element root, int i)}, die ein neues \bjava{Element} mit Wert \(i\) an das Ende der Liste, anhängt. Die Liste soll durch den Kopf \bjava{root} gekennzeichnet sein.
    \end{exercise}
\end{frame}
