...
\begin{frame}[fragile]{Listen -- Einfach verkettete Liste}
    ...
    \begin{itemize}[<+(1)->]
        ...
        \item Das erste Element, das die Liste beginnt, bezeichnen wir als \emph{Head}, das Letzte, das auf einen definierten letzten Wert (wie \bjava{null}) zeigt, nennen wir \emph{Tail}\thinspace /\thinspace \emph{Foot}.
    \end{itemize}\pause%
