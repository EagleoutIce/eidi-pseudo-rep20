...
\begin{frame}{Traversierung: Level-Order}
    ...
    \pause{}\begin{center}
        \scalebox{0.625}{\begin{forest}
            ...
            \scope[every path/.append style={draw,line width=3pt,lightgray!65!white,-Kite}]
...
\begin{frame}{Traversierung: Pre-Order}
    \begin{itemize}[<+(1)->]
        ...
        \item Mit der Pre-Order Strategie wird erst der aktuelle Knoten und dann rekursiv beide Teilbäume besucht.\pause{}
    \end{itemize}\medskip
    \pause\begin{center}
        \scalebox{0.625}{\begin{forest}
            for tree={inner sep=4pt,ball,font=\sffamily,outer sep=1pt,minimum width=1.15cm,edge=-Kite,s sep=3.5em-level*.65em}
    ...
    \end{center}
\end{frame}
% TODO: pre order without recursion but with stack
