...
\def\basegraph{%
    ...
    \node[ball,gray] (1) at (1,1.25) {};
    \node[ball,gray] (2) at (1,-1.25) {};
    \node[ball,gray] (3) at (2.5,1.25) {};
    \node[ball,gray] (4) at (2.5,-1.25) {};
...
\begin{frame}{Begriffe in einem Graphen}
    ...
    \begin{description}[Zusammenhang]
        \widei
        \item[Zusammenhang] Wenn jeder Knoten von jedem anderen aus (über die Kanten) erreicht werden kann.\pause{}\medskip % Gerichteter Graph: Unterscheidung zw. stark und schwach.
\begin{center}
    ...
    \end{tikzpicture}
\end{center}\pause{}
        \item[Grad] Die Anzahl an Knoten, die mit einem Knoten verbunden sind.\pause{} \textcolor{gray}{Ist der Graph gerichtet, so wird zwischen Eingangs- und Ausgangsgrad unterschieden.}
    \end{description}
\end{frame}
