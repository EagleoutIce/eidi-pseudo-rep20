...
\begin{frame}{Traversierung: In-Order}
    \begin{itemize}[<+(1)->]
        \item Es handelt sich um einen Tiefendurchlauf (\textit{depth-first}).
        \item Mit dieser Strategie wird erst rekursiv der linke Teilbaum bearbeitet, dann der Knoten selbst und dann rekursiv der rechte Teilbaum.\pause{} \textcolor{gray}{(Analog gespiegelt)}
    \end{itemize}
    \pause{}\begin{center}
        \scalebox{0.625}{\begin{forest}
            for tree={inner sep=4pt,ball,font=\sffamily,outer sep=1pt,minimum width=1.15cm,edge=-Kite}
