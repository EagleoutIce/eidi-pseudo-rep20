...
\begin{center}
\begin{tikzpicture}[scale=.5,gray,every node/.append style={font=\tiny}]
    \node[ball,gray] (0) at (0,0) {0};
    \node[ball,gray] (1) at (1,1.125) {1};
    \node[ball,gray] (2) at (1,-1.125) {2};
    \node[ball,gray] (3) at (2.5,1.125) {3};
    \node[ball,gray] (4) at (2.5,-1.125) {4};
    \node[ball,gray] (5) at (3.75,0) {5};
    \node[ball,gray] (6) at (5.25,0) {6};
    \node[ball,gray] (7) at (6.75,0) {7};
\end{tikzpicture}
\end{center}
...
\begin{frame}{Graphen durchsuchen: Tiefensuche}
    ...
    \begin{multicols}{5}
        \scriptsize%
    \begin{enumerate}[<+(1)->]
        \item \begin{tikzpicture}[scale=.625,every node/.style={transform shape},kreis/.style={inner sep=4pt,ball,font=\sffamily,outer sep=1pt},ikreis/.style={inner sep=4pt,iball,font=\sffamily,outer sep=1pt},armark/.style={thick,btcd@color@alerted},baseline=-0.6ex]
