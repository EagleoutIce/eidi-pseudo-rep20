...
\begin{frame}[c,fragile]{Übungsaufgabe}
    ...
    \begin{exercise}<2->[Fehler finden - Exceptions \Time{5}]
        \pause{}Erklären Sie alle Verletzungen der Java-Syntax (nehmen Sie an, dass die Import korrekt sind). \bjava{IOException} und \bjava{FileNotFoundException} sind checked-Exceptions. \pause{}
\lstfs{9}
\begin{plainvoid}
public class A {
