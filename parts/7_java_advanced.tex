...
\begin{frame}{Das Konzept der Vererbung}
    ...
    \begin{itemize}[<+(1)->]
        ...
        \item Die Subklasse kann heir auf zwei Weisen betrachtet werden: \begin{itemize}
...
\begin{frame}[c,fragile]{Übungsaufgabe}
    ...
    \begin{exercise}<2->[Fehler finden - Vererbung \Time{4}]
...
\begin{frame}{Abstrakte Klassen}
    \begin{itemize}[<+(1)->]
        ...
        \item Von \bjava{abstract} Klassen darf kein Objekt erstellt werden. \textcolor{gray}{(Von ihnen kann aber geerbt werden.)}
        \item Eine abstrakte Klasse kann abstrakte Methoden (ohne Rumpf!) definieren.\pause{} Diese \emph{müssen} von einer nicht-abstrakten erbenden Klasse implementiert werden.
    \end{itemize}
\end{frame}
