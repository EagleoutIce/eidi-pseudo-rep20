...
\begin{exercise}<2->[Vererbungshierarchien \Time{6}]
    \onslide<3->{\footnotesize Konstruieren Sie eine \textit{abstrakte} Klasse \solGet{keywordC}{Entity}, welche die gemeinsamen Eigenschaften folgender Klassen vereint und die Sichtbarkeiten und Modifikatoren bestmöglich rekreiert. \onslide<4->{Schreiben Sie diese außerdem so um, dass sie nun von \solGet{keywordC}{Entity} erben. Die Klasse \solGet{keywordC}{Point} sei gegeben.}}
\begin{columns}[c]
\lstfs{6}%
\begin{column}{.4\linewidth}
\begin{plainjava}[morekeywords={[3]{Enemy,Companion}},belowskip=0pt,aboveskip=3pt]
!*\onslide<5->*!class Enemy {
!*\onslide<5->*!  private final long id; private Point pos;
!*\onslide<5->*!  protected int hp, ap;
!*\onslide<5->*!  public Enemy(long id) { this.id = id; }
!*\onslide<5->*!  public void move(Point target) {
!*\onslide<5->*!    this.pos = target;
!*\onslide<5->*!  }
...
!*\onslide<6->*!  private final long id; private Point pos;
!*\onslide<6->*!  public Companion(long id) { this.id = id; }
!*\onslide<6->*!  public void move(Point target) {
!*\onslide<6->*!    this.pos = target;
!*\onslide<6->*!  }
!*\onslide<6->*!}
\end{plainjava}
\end{column}
...
!*\onslide<7->*!class NPC {
!*\onslide<7->*!  private final long id; private Point pos;
...
!*\onslide<7->*!  }
!*\onslide<7->*!  public void move(Point target) {
!*\onslide<7->*!    this.pos = target;
...
!*\onslide<3->*!    protected Point pos; // oder private mit Getter
!*\onslide<3->*!    public Entity(long id) { this.id = id; }
!*\onslide<3->*!    public void move(Point target) {
!*\onslide<3->*!        this.pos = target;
!*\onslide<3->*!    }
!*\onslide<3->*!}
\end{plainjava}
\begin{columns}[c]
